...
print(f"LV6 AGGRESSIVE — CONTINUOUS COMPOUNDING {START_DT.strftime('%b %Y')} -> {END_DT.strftime('%b %Y')}")
print(f"Starting capital: ${strat.TOTAL_CAPITAL} | Position: {strat.POSITION_PCT}% of equity | Max lev: {strat.MAX_LEVERAGE}x")
print(f"RR=9.0, SL=0.6xATR, BE=1.5R, Trail=3.5R | Min notional: ${strat.MIN_NOTIONAL}\n")
...
print(f"\n{'='*80}")
print(f"  LV6 AGGRESSIVE — FINAL RESULT")
print(f"{'='*80}")
