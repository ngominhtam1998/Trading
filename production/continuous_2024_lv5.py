...
print(f"LV5 AGGRESSIVE — CONTINUOUS COMPOUNDING {START_DT.strftime('%b %Y')} -> {END_DT.strftime('%b %Y')}")
print(f"Starting capital: ${strat.TOTAL_CAPITAL} | Position: {strat.POSITION_PCT}% of equity | Max lev: {strat.MAX_LEVERAGE}x")
print(f"RR=7.5, SL=0.7xATR, BE=1.3R, Trail=3.0R | Min notional: ${strat.MIN_NOTIONAL}\n")
...
print(f"\n{'='*80}")
print(f"  LV5 AGGRESSIVE — FINAL RESULT")
print(f"{'='*80}")
